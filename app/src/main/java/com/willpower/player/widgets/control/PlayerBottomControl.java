...
import com.willpower.player.widgets.MediaPlayerFrame;
    ...
    public void setMediaPlayer(MediaPlayerFrame player) {
        ...
        mMediaPlayer.addPlayerListener(new BaseMediaPlayerListener() {
            ...
            public void onStartPlay() {
                mPlayPauseBtn.setImageResource(R.drawable.pause_btn);
...
//                clearUpdateProgress();
                mPlayPauseBtn.setImageResource(R.drawable.play_btn);
                mSeekBar.setProgress(0);
                mCurrentProgressView.setText(MediaPlayerUtils.formatTime(0));
            }
